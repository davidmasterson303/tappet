 ...
 * `watchFolders` it neither resolves `@tappet/core` nor notices when it
...
/*
  ...
  React and react-native break loudly when duplicated. `@tappet/core` is
...
config.resolver.extraNodeModules = {
  ...
  '@tappet/core': path.resolve(workspaceRoot, 'packages/core'),
};
...
/*
  ...
  **Expo's Metro reads tsconfig `paths` too**, and honours them ahead of
  ...
  `@tappet/core/health-band` resolves through `@tappet/core/*` →
