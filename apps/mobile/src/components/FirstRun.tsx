...
/**
 * What Tappet does, said once, to someone who has never had a car in it.
 *
  ...
  return (
    <EmptyState
      ...
      /*
        ...
        being asked for on trust. "Add your first car and Tappet gets to work
        on it" — the copy this replaces — described the button rather than the
        product.
      */
      body="Add it and Tappet researches it: what it needs, what has been recalled, and what the work should cost."
