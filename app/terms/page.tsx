...
export const metadata: Metadata = {
  ...
  description: 'What Tappet is, what it is not, and the terms of using it.',
};
 ...
 *
 * "What Tappet is not." A product that tells people things about the safety
...
export default function TermsPage() {
  return (
    <LegalDocument
      title="Terms of Use"
      summary="Tappet helps you understand and look after your car. It is not a mechanic, and nothing it tells you is a substitute for someone qualified looking at the actual vehicle."
    >
      <p>
      ...
      <p>
        Tappet produces estimates, ranges and comparisons from the information you give it and
      ...
      <p>
        ...
        and Tappet does not check any of them. Modifying a vehicle may void warranties and may be
      ...
      <p>
        ...
        <strong className="text-white/90">deleting your Tappet account does not stop the
      ...
      <p>
        Tappet is provided as it is. We do not promise it will always be available, that its
