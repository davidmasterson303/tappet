 ...
 * "Tappet" as the subject of a sentence explaining the promise, then a
        ...
        <div className="px-4 sm:px-6 py-6 space-y-6">
          ...
          <div className="mt-2 p-4 rounded-xl bg-info-wash border border-info-border">
            <p className="text-xs text-gray-400 leading-relaxed">
              ...
              Tappet grows with your car. Every service record, every conversation, every decision you log makes future recommendations sharper and more personalized.
            </p>
          </div>
