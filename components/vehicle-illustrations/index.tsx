...
} from '@tappet/core/vehicle-body-style';
...
export { VEHICLE_BODY_STYLES, BODY_STYLE_LABEL } from '@tappet/core/vehicle-body-style';
export type { VehicleBodyStyle } from '@tappet/core/vehicle-body-style';
