...
import { CX, CY, R, TRACK, VIEW_H, VIEW_W, angleFor, pointAt } from '@tappet/core/cluster-geometry';
import type { BuildPosition } from '@tappet/core/build-progress';
 ...
 *
 * So the geometry is shared through `@tappet/core/cluster-geometry` and the
