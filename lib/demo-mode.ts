 ...
 * only reason that module touched `document`, and because `@tappet/core/routes`
 ...
 * `isDemoVehicleId` in `@tappet/core/demo` is the check that matters on the server
 * regardless.
 *
...
import { DEMO_COOKIE } from '@tappet/core/demo';
