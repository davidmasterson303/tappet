...
import { corsHeadersFor, isVersionedApiPath } from '@tappet/core/cors';
import { FRONT_DOOR_PATH } from '@tappet/core/front-door';
import { VISITOR_COOKIE, visitorCookieOptions } from '@tappet/core/funnel';
 ...
 *
 * That policy now lives in `@tappet/core/routes` so `components/AuthProvider.tsx`
